...
export const fetchAllUsers = createAsyncThunk(
    ...
    async(_,{ rejectWithValue }) => {
        try {
            const response = await axios.get(`https://event-management-backend-gqnh.onrender.com/api/v1/user/all`);
...
export const addNewUser = createAsyncThunk(
    ...
    async({registrationId, name, number, brandName, batchName, adminName},{rejectWithValue}) => {
        try {
            const response = await axios.post(`https://event-management-backend-gqnh.onrender.com/api/v1/user/register`,
...
export const fetchUserById = createAsyncThunk(
    ...
    async(userId,{rejectWithValue}) => {
        try {
            const response = await axios.get(`https://event-management-backend-gqnh.onrender.com/api/v1/user/${userId}`)
            return response.data;
        } catch (error) {
...
export const updateUserById = createAsyncThunk(
    ...
    async (updateUserData, { rejectWithValue }) => {
        try {
            const response = await axios.put(`https://event-management-backend-gqnh.onrender.com/api/v1/user/${updateUserData.userId}`, updateUserData);
            return response.data;
        } catch (error) {
...
export const deleteUserById = createAsyncThunk(
    ...
    async(userId, {rejectWithValue}) => {
        try {
            const response = axios.delete(`https://event-management-backend-gqnh.onrender.com/api/v1/user/${userId}/delete`);
