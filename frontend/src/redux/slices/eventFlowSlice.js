...
export const fetchAllEventFlows = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await axios.get('https://event-management-backend-gqnh.onrender.com/api/v1/eventflow/all'); // Your backend endpoint
    ...
    async({registrationId, adminName}, {rejectWithValue}) => {
        try {
            const response = await axios.post(
                'https://event-management-backend-gqnh.onrender.com/api/v1/eventflow/register',
...
export const deleteEventFlowById = createAsyncThunk('eventFlows/deleteEventFlowById', async (eventFlowId, {rejectWithValue}) => {
    try {
        const response = axios.delete(`https://event-management-backend-gqnh.onrender.com/api/v1/eventflow/${eventFlowId}/delete`);
...
export const eventFlowInfoById = createAsyncThunk(
  ...
  async({id},{rejectWithValue}) => {
    try {
      const response = await axios.get(`https://event-management-backend-gqnh.onrender.com/api/v1/eventflow/${id}`);
...
export const addStepFlow = createAsyncThunk(
  ...
  async ({ eventId, flowName, flowOrder, flowDescription, flowTag, adminName  }, { rejectWithValue }) => {
    try {
      const response = await axios.post(`https://event-management-backend-gqnh.onrender.com/api/v1/eventflow/${eventId}/addstepflow`,  
...
export const deleteStepFlow = createAsyncThunk(
  ...
  async ({ eventId, stepFlowId, adminName }, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.post(
        `https://event-management-backend-gqnh.onrender.com/api/v1/eventflow/${eventId}/deletestepflow`,
...
export const updateStatus = createAsyncThunk(
  ...
  async({eventId, flowId, flowStatus, adminName},{rejectWithValue}) => {
      try {
        const response = await axios.put(`https://event-management-backend-gqnh.onrender.com/api/v1/eventflow/${eventId}/updatestepflowstatus`,{flowId, flowStatus, adminName});
...
export const updateOrder = createAsyncThunk(
  ...
  async({eventId, stepFlowId, flowOrder, adminName},{rejectWithValue}) => {
    try {
        const response = await axios.put(`https://event-management-backend-gqnh.onrender.com/api/v1/eventflow/${eventId}/updatestepfloworder`,{stepFlowId, flowOrder, adminName});
