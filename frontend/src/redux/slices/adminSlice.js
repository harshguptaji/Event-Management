...
export const fetchAllAdmins = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
      try {
        ...
        const response = await axios.get('https://event-management-backend-gqnh.onrender.com/api/v1/admin/all', {
          headers: {
  ...
  export const createAdmin = createAsyncThunk(
    ...
    async (adminData, { rejectWithValue }) => {
      try {
        const response = await axios.post('https://event-management-backend-gqnh.onrender.com/api/v1/admin/register', adminData);
  ...
  export const fetchAdminById = createAsyncThunk('admin/fetchAdminById', async (id) => {
    const response = await axios.get(`https://event-management-backend-gqnh.onrender.com/api/v1/admin/${id}`);
  ...
  async ({ adminId, name, number, password, role }, { rejectWithValue }) => {
    try {
      const response = await axios.put(
        `https://event-management-backend-gqnh.onrender.com/api/v1/admin/${adminId}/edit`,
...
export const deleteAdmin = createAsyncThunk(
  ...
  async (adminId, { rejectWithValue }) => {
    try {
      const response = await axios.delete(`https://event-management-backend-gqnh.onrender.com/api/v1/admin/${adminId}`);
  ...
  async ({ adminId, tagName }, { rejectWithValue }) => {
    try {
      const response = await axios.post(
        `https://event-management-backend-gqnh.onrender.com/api/v1/admin/${adminId}/newtag`,
        { tagName }
      );
...
export const removeTagFromAdmin = createAsyncThunk(
  ...
  async ({ adminId, tagName }, { rejectWithValue }) => {
    try {
      const response = await axios.post(
        `https://event-management-backend-gqnh.onrender.com/api/v1/admin/${adminId}/removetag`, // Your backend endpoint for removing the tag
        { tagName }
      );
