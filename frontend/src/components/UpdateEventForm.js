...
import "../styling/UpdateEventForm.css";
 ...
 useEffect(() => {
  ...
  return (
    <div className='update-event-container'>
      <h2 className='update-event-title'>Update Event Information</h2>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          <label htmlFor="name" className='update-event-name'>Name :- </label>
          <input
        ...
        <div>
          <label htmlFor="description" className='update-event-description'>Description :- </label>
          <input
          className='input-desc-event'
            type="text"
            id="description"
            value={description}
        ...
        <div>
          <label htmlFor="venue" className='update-event-venue'>Venue :- </label>
          <input
          className='input-venue-event'
            type="text"
            id="venue"
            value={venue}
        ...
        <div>
          <label htmlFor="date" className='update-event-date'>Date :- </label>
          <input
